...
export const audiencias: any[] = [
  {
    ...
    endereco: 'Av. Paulista, 1912 — Bela Vista, São Paulo/SP — CEP 01310-200',
    latitude: -23.5600, longitude: -46.6590,
    ...
    participantes: [
      mkPart('USR-006', true,  hISO(8, 58), -23.5600, -46.6590, 5,  'EV-001'),
      mkPart('USR-007', true,  hISO(9, 2),  -23.5601, -46.6591, 8,  'EV-002'),
      mkPart('USR-008', true,  hISO(9, 5),  -23.5599, -46.6589, 6,  'EV-003'),
      mkPart('USR-009', true,  hISO(9, 10), -23.5602, -46.6592, 10, 'EV-004'),
      mkPart('USR-010', true,  hISO(9, 3),  -23.5598, -46.6588, 7,  'EV-005'),
      mkPart('USR-011', true,  hISO(8, 50), -23.5603, -46.6593, 3,  'EV-006'),
  ...
  },
  {
    ...
    endereco: 'Rua da Consolação, 247 — Consolação, São Paulo/SP — CEP 01301-000',
    latitude: -23.5533, longitude: -46.6578,
    raio_geofence_metros: 100, status: 'em_andamento',
    total_participantes: 6, presentes: 4, ausentes: 2, taxa_presenca: 0.667,
    pre_checkin_habilitado: true, offline_habilitado: true, questionario_habilitado: true,
    participantes: [mkPart('USR-006', true, hISO(9, 25), -23.5533, -46.6578, 4, 'EV-007'), mkPart('USR-008', true, hISO(9, 28), -23.5534, -46.6579, 6, 'EV-008'), mkPart('USR-009', true, hISO(9, 30), -23.5532, -46.6577, 5, 'EV-009'), mkPart('USR-011', true, hISO(9, 22), -23.5535, -46.6580, 8, 'EV-010'), mkPart('USR-007', false, null, null, null, null, null), mkPart('USR-010', false, null, null, null, null, null)],
  },
  {
    ...
    endereco: 'Praça João Mendes, s/n — Centro, São Paulo/SP — CEP 01501-900',
    latitude: -23.5474, longitude: -46.6363,
    ...
    participantes: [mkPart('USR-006', true, oISO(9, 55), -23.5474, -46.6363, 12, 'EV-011'), mkPart('USR-007', true, oISO(9, 58), -23.5475, -46.6364, 9, 'EV-012'), mkPart('USR-008', true, oISO(9, 50), -23.5473, -46.6362, 7, 'EV-013'), mkPart('USR-009', true, oISO(10, 0), -23.5476, -46.6365, 11, 'EV-014'), mkPart('USR-010', true, oISO(9, 52), -23.5472, -46.6361, 5, 'EV-015')],
  },
  {
    id: 'AUD-005', nome: 'Perícia Contábil — Ação 0231/2024',
    departamento: 'Jurídico Contencioso — Dr. Carlos Mendes',
    data: hoje, horario_inicio: '14:00', horario_fim: '16:00',
    local: 'Sala de Reuniões C — 2º Andar',
    endereco: 'Av. Paulista, 1374 — Bela Vista, São Paulo/SP — CEP 01310-100',
    latitude: -23.5614, longitude: -46.6549,
  ...
  },
  {
    ...
    local: 'Fórum Regional — Sala 12',
    endereco: 'Av. Prof. Alfonso Bovero, 664 — Perdizes, São Paulo/SP — CEP 01254-000',
    latitude: -23.5332, longitude: -46.6695,
